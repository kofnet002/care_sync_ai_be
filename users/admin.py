...
class ChecklistItemAdmin(admin.ModelAdmin):
    list_display = ('note', 'task', 'is_completed')
...
class ActionPlanAdmin(admin.ModelAdmin):
    list_display = ('note', 'action', 'frequency', 'start_date', 'end_date', 'is_active')
...
class ReminderAdmin(admin.ModelAdmin):
    list_display = ('action_plan', 'patient', 'title', 'scheduled_for', 'completed')
