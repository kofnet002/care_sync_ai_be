...
from .views import (
    ...
    DoctorListView, AssignDoctorView, MyPatientsView,
    CreateNoteView, ListPatientNotesView, ActionPlanView,
    ReminderView, ReminderCheckInView, ListPatientNotesView,
...
urlpatterns = [
    ...
    path('notes/patient/<int:patient_id>/', ListPatientNotesView.as_view(), name='patient-notes'),
